          ...
          >
            ...
            <div className="space-y-4">
              <motion.a 
                ...
                whileHover={{ x: 10 }}
                className="flex items-center space-x-3 text-gray-700 dark:text-gray-300 hover:text-secondary dark:hover:text-blue-400 transition-colors"
              >
          ...
          >
            ...
            {submitted ? (
              <motion.div
                ...
                className="bg-green-100 dark:bg-green-900/30 border border-green-400 dark:border-green-600 text-green-700 dark:text-green-400 px-4 py-3 rounded"
              >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-lg focus:ring-2 focus:ring-secondary focus:border-transparent outline-none"
                  />
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="w-full bg-primary hover:bg-secondary dark:bg-secondary dark:hover:bg-primary text-white font-bold py-3 px-6 rounded-lg transition-colors"
                >
                  Send Message
                </motion.button>
              </form>
